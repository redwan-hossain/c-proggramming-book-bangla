...
&& এবং || দুইটা কন্ডিশনকে combine করে। `&&` এর বেলায় দুইটা কন্ডিশনই সত্য কিনা যাচাই করা হয়। `||` এর বেলায় যেকোনো একটা কন্ডিশন সত্য কিনা সেটা যাচাই করা হয়।&#x20;
...
এদের সবারই দুইটা operand লাগে তাই এরা বাইনারী operator.
